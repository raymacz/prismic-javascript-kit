        ...
        <script src="js/vendor/prismic.io-1.0.29.min.js"></script>
...
<------------ pagination --->
   ...
   <!------------------ need this to access everything ------->     
...
<!----- =========== error.html =============== ERROR PAGE SERVER SIDE --->

     <h1>An error happened on the server side</h1>
        ...
        <script type="text/javascript">
            $(function(){
                if (window.location.hash && window.location.hash.length>1) {
                    $('h1').html("An error happened on the server side: "+window.location.hash.substring(1));
                }
            });
        </script>

<!----- =========== notfouapnd.html =============== PAGE NOT FOUND --->
